...
let
      x86_64pkgs = import nixpkgs-unstable { system = "x86_64-linux"; config.allowUnfree = true; };
      aarch64pkgs = import nixpkgs-unstable { system = "aarch64-linux"; config.allowUnfree = true; };
