...
{ ... }:
let
  # anvil's outputs (from `xrandr`): laptop panel + office externals.
  # NOTE: This should be aligned with the outputs in ../monitors.nix
  monitors = ["eDP" "DisplayPort-3" "DisplayPort-4" "DisplayPort-6"];
