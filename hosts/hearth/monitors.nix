{pkgs, ...}: {
  ...
  services.xserver.displayManager.sessionCommands = ''
    # Create a 5120x1440 120Hz mode and add it to DP-3, this is at the very limit of DisplayPort 1.4 without
    # DSC (Display Stream Compression), as this requires ~24.5Gbps and maximum bandwidth is ~25.9Gbps.
